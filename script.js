...
(function () {
    ...
    function openModal(key) {
      ...
      if (isCompleted) {
        actionsSlot.innerHTML = `
          <a href="https://devloper-anik.github.io/Protfolio.in/" class="btn btn-primary magnetic"target="_blank"
  ...
  class="btn btn-ghost magnetic">
          ...
          <a href="https://github.com/Devloper-ANIK" class="btn btn-ghost magnetic" target="_blank"
  rel="noopener noreferrer"
  class="btn btn-ghost magnetic" >
        ...
        actionsSlot.innerHTML = `
          <a href="https://devloper-anik.github.io/Protfolio.in/" class="btn btn-ghost magnetic" target="_blank"
  rel="noopener noreferrer"
  class="btn btn-ghost magnetic" >
